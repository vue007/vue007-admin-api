...
public class ShiroJWTConfiguration {
    ...
    public HashedCredentialsMatcher hashedCredentialsMatcher() {
        ...
        credentialsMatcher.setHashAlgorithmName(ShiroJWTConfiguration.PASSWORD_ENCRYPT);
        credentialsMatcher.setHashIterations(ShiroJWTConfiguration.PASSWORD_ENCRYPT_TIMES);
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean() {
        ...
        FormAuthenticationFilter authc = new StatelessAuthcFilter();
        //登录地址
